...
class NetworkingPageContent extends StatefulWidget {
  const NetworkingPageContent({super.key});

  @override
  NetworkingPageContentState createState() => NetworkingPageContentState();
}

class NetworkingPageContentState extends State<NetworkingPageContent> {
...
class TextAndButton extends StatelessWidget {
  const TextAndButton({super.key, this.content, this.buttonText, this.onPressed});
