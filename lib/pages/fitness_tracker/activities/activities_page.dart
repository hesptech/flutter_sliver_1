...
import 'package:flutter_sliver_1/pages/fitness_tracker/activities/activity_card.dart';
import 'package:flutter_sliver_1/pages/fitness_tracker/activities/profile_header.dart';
...
class ActivitiesPage extends StatelessWidget {
  ...
  factory ActivitiesPage.withSampleData() {
    return const ActivitiesPage(user: sampleUser, activities: sampleActivities);
  }
  ...
  static const sampleActivities = <Activity>[
    Activity(
